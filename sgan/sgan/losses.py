...
def gan_g_loss(scores_fake):
    ...
    """
    y_fake = torch.ones_like(scores_fake) * random.uniform(0.8, 1.0)
...
def gan_d_loss(scores_real, scores_fake):
    ...
    """
    y_real = torch.ones_like(scores_real) * random.uniform(0.8, 1.0)
    y_fake = torch.ones_like(scores_fake) * random.uniform(0, 0.2)
